...
<%@page import="com.ekart.util.ConnectionFactory"%>
				...
				<div id="cbp-vm" class="cbp-vm-switcher cbp-vm-view-grid">
					...
					<ul>
						<%
							...
							String query="select * from mRishikeshrao.order where orderId IN (select orderId from customer_order where customerId="+customerId+")";
